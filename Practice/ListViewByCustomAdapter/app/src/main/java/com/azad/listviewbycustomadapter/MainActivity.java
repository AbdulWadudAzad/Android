package com.azad.listviewbycustomadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    int[] flags = {R.drawable.afghanistan, R.drawable.armenia, R.drawable.azerbaijan, R.drawable.bahrain,
            ...
            , R.drawable.cyprus, R.drawable.georgia, R.drawable.egypt, R.drawable.georgia, R.drawable.india, R.drawable.indonesia
